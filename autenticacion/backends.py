...
class EmpleadosBackend(BaseBackend):
    """
    Autentica contra la tabla 'empleados' y crea/actualiza un usuario 'sombra' en auth_user
    para poder usar sesiones/permisos/admin sin reemplazar AUTH_USER_MODEL.
    """
